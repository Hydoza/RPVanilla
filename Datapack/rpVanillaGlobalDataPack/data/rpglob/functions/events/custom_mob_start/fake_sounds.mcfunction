...
execute as @e[name=fake_sound1] at @s if score fake_sounds_count event1 matches 6 run playsound minecraft:block.end_portal.spawn ambient @a ~ ~ ~ 10 0.1
execute as @e[name=fake_sound1] at @s if score fake_sounds_count event1 matches 14 run playsound minecraft:entity.lightning_bolt.impact ambient @a ~ ~ ~ 10 1
execute as @e[name=fake_sound1] at @s if score fake_sounds_count event1 matches 19 run playsound minecraft:entity.lightning_bolt.impact ambient @a ~ ~ ~ 10 1
